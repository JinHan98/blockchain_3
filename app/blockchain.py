...
class Blockchain:
    ...
    def chain_is_valid(self, chain):
            ...
            for i in range(1, len(chain)):
                ...
                if i!=1 and block_hash[:4] != "0000":# i가 1이 아니거나 hash값 찾은 hash값 조건 넣기 :
                    validChain = False

                if  i !=1 and current_block["previous_block_hash"]!= prev_block["hash"]:#i가 1이 아니거나 현재 블럭의 previous_hash값과 이전 블럭의 hash값이 같은지 비교:
                    validChain = False
